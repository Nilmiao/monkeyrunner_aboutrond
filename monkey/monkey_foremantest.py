...
packageName="com.trond.foreman"
logdir='/Users/admin/Documents/autotest/foremanlog'

remote_path='/Users/admin/Documents/autotest/foremanlog'



os.system("adb -s cf615425 shell cat /system/build.prop >/Users/admin/Documents/autotest/foremanlog/phone.txt")

f = "/Users/admin/Documents/autotest/foremanlog/phone.txt"
...
print monkeylogname
cmd="adb -s cf615425 shell monkey -p com.trond.foreman --ignore-timeouts --monitor-native-crashes -v -v 20000 >%s" %(monkeylogname)
