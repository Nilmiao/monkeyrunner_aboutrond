...
packageName="com.trond.supervisor"
logdir='/Users/admin/Documents/autotest/supervisorlog'

remote_path='/Users/admin/Documents/autotest/supervisorlog'



os.system("adb -s cf615425 shell cat /system/build.prop >/Users/admin/Documents/autotest/supervisorlog/phone.txt")

f = "/Users/admin/Documents/autotest/supervisorlog/phone.txt"
...
print monkeylogname
cmd="adb -s cf615425 shell monkey -p com.trond.supervisor --ignore-timeouts --monitor-native-crashes -v -v 20000 >%s" %(monkeylogname)
