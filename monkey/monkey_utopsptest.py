...
packageName="com.qttecx.utopsp"
logdir='/Users/admin/Documents/autotest/utopsplog'

remote_path='/Users/admin/Documents/autotest/utopsplog'



os.system("adb -s cf615425 shell cat /system/build.prop >/Users/admin/Documents/autotest/utopsplog/phone.txt")

f = "/Users/admin/Documents/autotest/utopsplog/phone.txt"
...
print monkeylogname
cmd="adb -s cf615425 shell monkey -p com.qttecx.utopsp --ignore-timeouts --monitor-native-crashes -v -v 20000 >%s" %(monkeylogname)
